...
const GenerateMnemonics = ({ setNext }: { setNext: (messge: any) => void }) => {
  ...
  return (
    ...
    >
      <Card className="text-secondary h-auto w-auto rounded-md border-2 border-amber-950 bg-amber-100/10 p-6 text-lg font-semibold tracking-wider shadow-none shadow-amber-800">
        ...
        <CardContent className="flex h-[200px] max-w-[800px] items-center justify-center">
          {buttonClicked == false && (
            <Button
              onClick={() => {
